                    ...
                    <form class="forms-sample" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control mb-4 mb-md-0" value="{{old('admission_number')}}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control mb-4 mb-md-0" value="{{old('roll_number')}}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="class_id" id="class_id" class="form-control form-select" required>
                                    ...
                                    @foreach ($getClass as $value)
                                        <option {{(old('class_id') == $value->id) ? 'selected' : ''}} value="{{$value->id}}">
                                            {{$value->name}}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control mb-4 mb-md-0" value="{{old('caste')}}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control mb-4 mb-md-0" value="{{old('religion')}}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control mb-4 mb-md-0" value="{{old('blood_group')}}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control mb-4 mb-md-0" value="{{old('height')}}"
                                    name="height" placeholder="Height">
                                <div class="text-danger">{{$errors->first('height')}}</div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Weight <span class="text-danger"></span></label>
                                <input type="text" class="form-control mb-4 mb-md-0" value="{{old('weight')}}"
