                    ...
                    <form class="forms-sample" method="get">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <a href="{{url('admin/class/list')}}" class="btn btn-inverse-danger"
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center p-4">
                    ...
                    <a href="{{url('admin/class/add')}}" class="btn btn-outline-light">Add Class</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($getRecord as $value)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn" href="{{url('admin/class/edit/' . $value->id)}}">
                                                <i data-feather="edit" class="link-icon text-warning"></i>
                                            </a>
                                            <a class="btn" href="{{url('admin/class/delete/' . $value->id)}}">
